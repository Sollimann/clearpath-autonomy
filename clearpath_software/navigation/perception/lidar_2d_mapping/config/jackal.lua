...
options = {
  ...
  published_frame = "odom", --mabye change to base_link --
  odom_frame = "odom", -- mabye change to base_link --
  ...
  num_subdivisions_per_laser_scan = 10, --must be same as velodyne publish frequency, 10Hz--
  num_point_clouds = 1,
